...
import { LanguageProvider, isLocale, localePersister } from '../translations';
import 'locomotive-scroll/dist/locomotive-scroll.css';

function CoreApp({ Component, pageProps, router }) {
  const { query: { lang } } = useRouter();
  
  // TODO добавить редирект для несуществующих локалей
  useEffect(() => {
    if(lang && isLocale(lang)) {
      localePersister.set(lang)
    }
  }, [lang])
